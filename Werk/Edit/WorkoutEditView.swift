...
struct WorkoutEditViewForm: View {
    @Environment(\.presentationMode) var presentationMode
    @ObservedObject var viewModel: WorkoutEditViewModel = WorkoutEditViewModel(workout: .initial)
...
struct WorkoutEditViewForm_Previews: PreviewProvider {
    static var previews: some View{
        WorkoutEditViewForm(
            viewModel: WorkoutEditViewModel(workout: Workout.initial))
    }
}
